...
#at this point we can transform the data if we wish. However, we first seek a simple model. Intuitively we could reject factors that do not effect survival, say the name (although there is possibly subtle features we could extract).
